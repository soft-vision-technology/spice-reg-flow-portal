import React, { useContext, useMemo, useState, useEffect, useId, createContext, forwardRef } from "react";
import * as RechartsPrimitive from "recharts";
import { cn } from "../../lib/utils"; // your classnames utility, replace if needed

// Theme selectors for styling
...
// Main container for chart - handles theme colors injection & responsive container
    ...
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        className={cn(
          ...
          // ...rest of your styles, simplified example
          className
        )}
        {...props}
      >
...
// Inject CSS variables dynamically for theme colors
...
// Tooltip content using config for labels/colors/icons
...
// Helper to extract config for each payload item
