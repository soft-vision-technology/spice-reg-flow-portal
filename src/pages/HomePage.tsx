        ...
        <div className="py-24">
          <div className="text-center mb-16">
            ...
            <Paragraph className="text-xl text-earth-500 mt-6 max-w-3xl mx-auto">
              Register your spice business, export operations, or trading services in our
              comprehensive industry database to access resources and connect with stakeholders.
            </Paragraph>
            <Link to="/select">
              <Button 
                type="primary" 
          ...
          <Row gutter={[24, 24]} className="mt-16">
            <Col xs={24} md={8}>
              ...
              >
                <Title level={4} className="text-earth-700">Entrepreneurs</Title>
            ...
            <Col xs={24} md={8}>
              <Card 
                className="h-full border-0 shadow-md rounded-xl hover:shadow-lg transition-shadow"
                cover={
                  <div className="h-40 bg-gradient-to-br from-earth-400 to-earth-600 rounded-t-xl flex items-center justify-center">
                    <span className="text-4xl text-white">🌍</span>
                  </div>
                }
              >
                <Title level={4} className="text-earth-700">Exporters</Title>
                <Paragraph className="text-earth-500">
            ...
            <Col xs={24} md={8}>
              ...
              >
                <Title level={4} className="text-earth-700">Intermediary Traders</Title>
                <Paragraph className="text-earth-500">
